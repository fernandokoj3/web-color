...
class AppErrorCode(Enum):
    ...
    SETUP_ERROR = InfoAppErrorCode(5, "Needs to review setup config.")
...
class SetupErrorException(ApplicationException):
    def __init__(
        self,
        msg: Union[str, list] = None,
        detail: Any = None,
    ):
        super(SetupErrorException, self).__init__(
            AppErrorCode.SETUP_ERROR,
            msg,
            detail,
